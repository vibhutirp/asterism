# Asterism Memory — Product Overview

Judge-facing product context: problem, users, features, market, and roadmap.
For developer setup and API usage, see the root README.md.
